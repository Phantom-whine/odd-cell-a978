...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/odd-cell-a978)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/odd-cell-a978
```

A live public deployment of this template is available at [https://odd-cell-a978.templates.workers.dev](https://odd-cell-a978.templates.workers.dev)
